      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-lg text-text-secondary leading-relaxed">
            Hello! I'm Himanshu, a Software Engineer and Full-Stack Developer passionate about building scalable, high-performance applications and intuitive user experiences. With experience in designing robust systems and solving complex problems, I focus on delivering solutions that make an impact.
          </p>
        </motion.div>
